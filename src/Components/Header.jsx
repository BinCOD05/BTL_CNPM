...
const navItems = [
  ...
  { label: 'Giỏ hàng', to: '/shopping-cart' },
];
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur shadow-sm">
      <div className="mx-auto flex h-20 w-full max-w-6xl items-center justify-between px-6">
        <Link to="/" className="text-2xl font-bold tracking-widest text-slate-900 font-Bitcount">
          SopPings
        </Link>
        ...
        <Link
          to="/user"
          className="rounded-full border border-slate-900 px-4 py-2 font-semibold text-slate-900 transition-colors duration-300 hover:bg-slate-900 hover:text-white"
        >
          Đăng nhập
        </Link>
      </div>
